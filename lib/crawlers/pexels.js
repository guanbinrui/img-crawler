            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        ids = $('img')
                            .toArray()
                            .map(function (n) { return n.attribs.src; })
                            .filter(function (url) { return /photos\//.test(url); })
                            .map(function (url) {
                            var result = url.match(/photos\/(\d+)\/pexels\-photo-(\d+)/);
                    ...
                    case 2:
                        ...
                        image.vid = id;
                        _b = image;
                        return [4 /*yield*/, Vendor_1.Vendor.findOne({ name: configs_1.VendorType.PEXELS })];
                    case 3:
                        _b.vendor = _c.sent();
